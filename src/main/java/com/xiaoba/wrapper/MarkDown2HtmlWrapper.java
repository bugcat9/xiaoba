...
import com.xiaoba.util.FileReadUtil;
...
public class MarkDown2HtmlWrapper {
    ...
    static {
        try {
            MD_CSS = FileReadUtil.readAll("templates/css/huimarkdown.css");
    ...
    public static MarkdownEntity ofContent(String content) {
        ...
        entity.setHtml(html);
        entity.addDivStyle("class", "templates/css/markdown-body ");
        return entity;
    }
